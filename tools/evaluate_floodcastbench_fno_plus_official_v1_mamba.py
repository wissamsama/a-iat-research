...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate official FNO+ v1 normalized latent-Mamba experiment.")
    ...
    output = args.output or (args.run_dir / f"{args.split}_metrics_checkpoint_best_official_v1_mamba.json")
    if output.exists():
