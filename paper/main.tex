...
test protocol (13/13 windows) for \mfifty{} and \mninetyfive{}. The dense
row uses the 4-window screening read pending a full-protocol re-run
(\S\ref{sec:protocol}); the pattern already matches the sparse rows'
direction. \textbf{Bold} marks the better model per row. The rightmost
...
\midrule
dense & 0.001576 $\pm$ 0.000668 & $\mathbf{0.000417 \pm 0.000039}$ & \twin{}, $\times$3.8 & yes \\
