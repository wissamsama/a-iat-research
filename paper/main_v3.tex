...
\blocked{Remaining: one further lever (diffusion steps, 40$\to$20) ---
training in progress, 5 of 6 configurations complete. 3-seed
confirmations warranted for the pushforward lever (single-seed result
outside the pattern of the others) and optionally the two CSI@0.001
drops (spatial encoder, target-step rainfall).}
