...
\blocked{Remaining: three further levers of the component ablation
(target-step rainfall, spatial encoder, diffusion steps) --- training
in progress, 3 of 6 configurations complete. A 3-seed confirmation of
the pushforward lever specifically is warranted given its single-seed
result falls outside the pattern of the other two completed levers.}
