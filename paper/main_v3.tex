...
\blocked{Remaining: five further levers of the component ablation
(target-step rainfall, spatial encoder, change-weighted loss,
rollout-aware training, diffusion steps) --- training in progress,
