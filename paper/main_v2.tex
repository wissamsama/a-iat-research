...
\blocked{One addition remains to strengthen this introduction before
freeze, without changing its claims: the cross-region transfer section
(\S\ref{sec:zeroshot}) currently rests on a 3-window UK test split ---
the Pakistan$\to$Mozambique replication (in progress at the time of
